...
const outputDir = process.argv[3] || "ARCHIVE/ignored-local/wix-export";

if (!input) {
  console.error("Usage: node MIGRATION/extract-wix-media.mjs path/to/wix-network.har [output-dir]");
  process.exit(1);
}
