...
const input = process.argv[2] || "99_ARCHIVE/ignored-local/wix-export/wix-media-urls.txt";
const outputDir = process.argv[3] || "99_ARCHIVE/ignored-local/original-assets";
