(() => {
  ...
  mediaAddButton.addEventListener('click', () => {
    ...
    renderHero(); renderEditorList(); syncControls(); selectMedia(item); save('Photo added to this device’s homepage carousel.');
    closeMediaBrowser();
  });
  document.getElementById('heroReset').addEventListener('click', () => {
    ...
    saveState.textContent = 'Approved website setup restored.';
  });
