...
const sourceDir = process.argv[2] || "original-assets";
const productionDir = process.argv[3] || "assets/production";
const outputDir = process.argv[4] || "migration";
...
await writeFile(path.join("docs", "source-asset-inventory.md"), markdown);
...
console.log("Wrote docs/source-asset-inventory.md");
