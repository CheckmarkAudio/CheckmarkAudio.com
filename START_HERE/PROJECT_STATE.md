...
- Services' six-state signal-path selector, matched cinematic Studio A/B pages and galleries, the four-person editorial Team composition, and Community's broadcast-wall layout with an aligned foreground cutout and distressed title.
...
- The September 5 Team fix: at widths up to 620px, all four current profiles appear in a compact vertical list with 112px portraits and visible names/roles. The former horizontal carousel and its script are no longer loaded. The September 5 roster update removes Matt Bow at Bridget’s request: four equal desktop columns, two tablet columns, and one compact phone column. Tony still needs an approved portrait.
