...
| `ui_kits/learning-app/` | High-fidelity recreation of the student/teacher learning UI — `learning-app-preview.html` (interactive demo) + JSX components. See its own README. |
